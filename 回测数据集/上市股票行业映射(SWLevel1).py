...
stock_daily_data = pd.read_csv('20170930-20251231_ori.csv')
sorted_result = pd.read_csv('SWlevel1_sorted_ori.csv')
...
print(len(all_result_data[all_result_data['industry_name']=='未分类']))
